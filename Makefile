...
# bin/test_rew_calc
EXE := bin/reweigh bin/hist_H2j bin/plot
...
# main object rules
lib/cross_section.o lib/test_rew_calc.o lib/reweigh.o lib/hist_weights.o lib/select_old_weight_hists.o lib/draw_together.o lib/plot.o: lib/%.o: src/%.cc
...
lib/cross_section.o: src/BHEvent.h
...
# EXE dependencies
bin/cross_section  : lib/BHEvent.o
